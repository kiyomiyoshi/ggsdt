...
The `ggsdt` package implements generalized gaussian signal detection theory analysis (https://www.biorxiv.org/content/10.1101/2022.10.28.514329v1).
...
`nR_S1` and `nR_S2` are response frequency vectors, ordered from highest confidence S1 to highest confidence S2.  
